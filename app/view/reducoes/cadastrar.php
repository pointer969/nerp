	...
	<form id="validate" class="form" method="post" action="" name="cadastrar">
		<div class="widget">
			<div class="title">
				...
				<h6>Cadastrar Redu&ccedil;&atilde;o Z</h6>
			</div>
			<div class='formRow'>
				<label>Codigo:</label>
				<div class='formRight'>
			...
			<div class='formRow'>
				...
				<div class='formRight'>
					<input type='number' name='contador' style='width:50px;' value='<?php echo $this->contador; ?>'<?php  if($this->contador){echo "disabled";} ?>/>
				</div>
				<div class='clear'></div>
			</div>
			<div class='formRow'>
...
<a href="<?php echo URL ?>Reducoes/Listar" title="" class="wButton bluewB ml15 m10" style="margin: 18px 18px 0 0; float: right;"> 
	<span>Voltar</span> 
</a>
