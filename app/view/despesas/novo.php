	...
	<form id="validate" class="form" method="post" action="" name="cadastrar">
		...
		<div class="widget">
			...
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" class="validate[required]" name="titulo" value="<?php echo $this->titulo ?>"/>
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
			...
			<div class="formRow">
				...
				<fieldset>
					<div class="widget pagamentos" id="chqcliente">
						<div class="title">
							<img src="<?php echo Folder ?>images/icons/dark/priceTag.png" alt="" class="titleIcon" />
							<h6>Pagamento Cheque de Clientes <span id="totalCheques">( Total: R$ <span id="total"></span> | Falta: R$ <span id="restante"></span> )</span></h6>
						</div>
						<div class="formRow">
							<label>Cheques:</label>
				...
				<fieldset>
					<div class="widget pagamentos" id="cartao">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<input type="number" class="validate[required]" name="parcelas" value="<?php echo $this->parcelas ?>"/>
							</div>
							<div class="clear"></div>
						</div>
...
<a href="<?php echo URL ?>Despesas" title="" class="wButton bluewB ml15 m10" style="margin: 18px 18px 0 0; float: right;"> 
	<span>Voltar</span> 
</a>
