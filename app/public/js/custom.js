$(function() {
	...
	$(".actBtns a").click(function(e) {


		

		if ($(this).attr("original-title")) {
			var funcao = $(this).attr("original-title");
		}else{
			var funcao = $(this).attr("title");
		}

		var link = $(this).attr("href");
 
		txt = "Você tem certeza que deseja "+funcao+" este Item?<br><br><br><span style='color:red;'>*Ela poderá ser permanente!</span>";
	
	
		Boxy.confirm(txt, function() { 
			location.href=link
		}, {title: "Deseja realmente fazer isso?",modal:true});
	...
	$(".chaveNFe").mask("9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999");
	...
	$(".agenciabb").mask("9999-9");
	$(".contabb").mask("99999-9");
	...
	$(".datepickerInline").mask("99-99-9999");

	$("input[type=number]").attr("step","0.1");
	...
	*/
	...
	$("#usualValidate").validate({
		...
		messages : {
			customMessage : {
				required : "Esta Mensagem � edit�vel"
			},
	...
	$("#wizard2").formwizard({
		...
		validationOptions : {
			...
			messages : {
				...
				email : {
					required : "Por favor, especifíque seu e-mail",
					email : "O formato correto é nome@dominio.com.br"
				}
			}
		}
	});
	...
	*/
	...
	/*
	* $('.smalldd ul li').mouseover( function() {
	* $(this).prev('li').css('border-bottom-color', '#3d434a') } );
	*
	* $('.smalldd ul li').mouseout( function() {
	* $(this).prev('li').css('border-bottom-color', '#1c252a') } );
*/
...
*/
	...
	/*
	* $(document).bind('click', function(e) { var $clicked = $(e.target); if (!
	* $clicked.parents().hasClass("smalldd")) $(".smallDropdown").slideUp(200);
	* });
*/
	...
	*/
	...
	// Run function on any div with
	// class name of "Content Tabs"
	...
	var opts = {
		...
		'sLink' : {
			...
			//
			// method 1: on initalisation call the add method directly and
			// format html manually
			init : function(e, ui) {
