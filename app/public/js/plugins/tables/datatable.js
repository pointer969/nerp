	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Regsitros Por Pagina:</span> _MENU_",
				"sZeroRecords": "Nao ha registros correspondentes foram encontrados",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>Busca:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Primeiro",
					"sPrevious": "Anterior",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="Informe sua busca..." /><div class="srch"></div>';
