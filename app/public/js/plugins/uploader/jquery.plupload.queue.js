	...
	function b(f, e) {
		...
		e
				.prepend('<div class="plupload_wrapper plupload_scroll"><div id="'
						+ f
						+ '_container" class="plupload_container"><div class="plupload"><div class="plupload_content"><div class="plupload_filelist_header"><div class="plupload_file_name">'
						+ a("Nome do Arquivo")
										...
										function(l, m) {
											...
											if (l.features.dragdrop
												...
												c("#" + k + "_filelist")
														.append(
																'<li class="plupload_droptext">'
																		+ a("Arraste e Solte o Arquivo Aqui!")
																		+ "</li>")
											}
											c("#" + k + "_container").attr(
													"title",
