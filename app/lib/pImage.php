...
class pImage extends pDraw
{
	...
	/* Font properties */
	var $FontName	= "app/public/fonts/Forgotte.ttf";	// Default font file
	...
	function render($FileName="app/public/images/grafs/output.png")
	{
	...
	function autoOutput($FileName="app/public/images/grafs/output.png")
	{
